...
class ProfileController extends AbstractController
{
    ...
    public function index(Request $request, UtilisateurRepository $utilisateurRepository, EntityManagerInterface $em): Response
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($motDePasse) $user->setMotDePasse($motDePasse);
